...
import com.example.serviceauthent.Configuration.JwtService;
import com.example.serviceauthent.Token.Token;
import com.example.serviceauthent.Token.TokenRepository;
import com.example.serviceauthent.Token.TokenType;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        var user = Account.builder()
                ...
                .role(Role.EMPLOYER) // Default role is USER
                .build();
    ...
    public void refreshToken(
        ...
        userEmail = jwtService.extractPhoneNumber(refreshToken);
        if (userEmail != null) {
